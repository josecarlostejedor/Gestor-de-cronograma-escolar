...
FIXED_API_KEY = ""  # Pega aquí tu API Key
FIXED_BIN_ID = ""   # Pega aquí tu Bin ID
              ...
              <div className="max-w-8xl mx-auto bg-white rounded-xl shadow-xl overflow-hidden border border-gray-200">
                <div className="overflow-x-auto">
                  <div className="min-w-[1200px]">
                    ...
                    <div className="sticky top-20 z-30 grid grid-cols-[120px_repeat(5,1fr)] border-b-2 border-gray-200 bg-gray-50 shadow-sm">
